...
describe('User', () => {
  ...
  describe(User.loggingIn.name, function () {
    it('is not implemented');
  });
  describe(User.loggingOut.name, function () {
    it('is not implemented');
  });
  ...
  describe(User._login.name, function () {
    it('is not implemented');
  });
  describe(User._startLoggingIn.name, function () {
    it('is not implemented');
  });
  describe(User._endLoggingIn.name, function () {
    it('is not implemented');
  });
  describe(User._endLoggingOut.name, function () {
    it('is not implemented');
  });
